 ...
 *
 * GIVE CREDIT TO https://github.com/vlandham/scroll_demo
 * Jim Vallandingham
...
var scrollVis = function() {
  ...
  setupVis = function(wordData, fillerCounts, histData) {
    ...
    // count openvis title
    g.append("text")
      .attr("class", "title openvis-title CO2")
	  .style("font-size", 40)
      .attr("x", width / 2)
      .attr("y", height / 5)
    ...
    g.append("text")
      .attr("class", "sub-title openvis-title CH4")
	  .style("font-size", 30)
      .attr("x", width / 2)
      .attr("y", (height / 5) + (height / 6) )
      .text("Methane (CH4)");

    g.append("text")
      .attr("class", "sub-title openvis-title FGas")
	  .style("font-size", 30)
      .attr("x", width / 2)
      .attr("y", (height / 5) + (height / 4) )
      .text("Flourinated Gases (aka 'F-Gases')");
